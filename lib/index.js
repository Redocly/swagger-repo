...
exports.compileIndexPage = function(options = {}) {
  const fileContents = readFileOrDefault('web/index.html',
    '<!doctype html><html lang="en"><head><meta charset="utf-8">'
    + '<title>Redoc</title></head><body>{{redocBody}}</body></html>',
...
exports.bundle = function(options = {}) {
  ...
  if (!options.skipPlugins) {
    runPlugins(spec, options);
  }

  return spec;
};

function runPlugins(spec, options) {
...
function readFileOrDefault(fileName, defaultVal, defaultMessage) {
  try {
