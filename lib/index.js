...
exports.swaggerEditorMiddleware = function (baseDir) {
  ...
  router.put('/backend_swagger.yaml', function (req, res) {
    exports.syncWithSwagger(req.body, baseDir);
    res.end('ok');
    //TODO: error handling
  });
...
exports.syncWithSwagger = function (swagger, baseDir) {
  var mainFile = baseDir + 'swagger.yaml';
  var pathsDir = baseDir + 'paths/';
  var definitionsDir = baseDir + 'definitions/';
  var codeSamplesDir = baseDir + 'code_samples/';
...
exports.bundle = function (options) {
  options = options || {};
  var mainFile = options.basedir + 'swagger.yaml';
  var pathsDir = options.basedir + 'paths/';
  var definitionsDir = options.basedir + 'definitions/';
  var codeSamplesDir = options.basedir + 'code_samples/';
